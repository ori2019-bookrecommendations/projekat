...
class ContentBasedFiltering:
    ...
    def train(self):
        ...
        print("Treniranje zavrseno, trajanje %s sekundi. " % (time.time() - start))
    ...
    def recommend(self, books, book_ids, n=20):
        ...
        return recommendations[['book_id', 'authors', 'title']]
...
def acumulate_tags(books, book_tags, tags):
    # Accumulates all the tags of a book in a dict
        ...
        print("Akumuliranje tagova zavrseno, trajanje %s sekundi. " % (time.time() - start))
